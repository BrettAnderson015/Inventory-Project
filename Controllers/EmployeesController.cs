...
namespace InventoryProject.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult SearchForEmployee(string name)
        {
            var emp = db.Employees.Where(e => e.FirstName == name).SingleOrDefault();

            if (emp == null)
            {
                ModelState.AddModelError(string.Empty, "Invalid employee name");
